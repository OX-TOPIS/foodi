...
const Category = () => {
  return (
    <div className='section-container py-16'>
      ...
      {/* category caards */}
      <div className="flex flex-row flex-wrap gab-8 justify-around items-center mt-12 ">
        {
            categoryItems.map((item, id)=>(
                <div className="shadow-lg rounded-md bg-white py-6 px-5 w-72 mx-auto text-center
                cursor-pointer hover:-translate-y-4 duration-300 transition-all items-center" key={id}>
